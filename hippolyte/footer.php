...
<!--         <div id="contact">
                        ...
                        <ul class="small-block-grid-1 large-block-grid-4">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class="fi-mail"></i> info@yourdomain.com
                                    </li>
                                </ul>
        ...
        <div class="copy">
            <div class="row2">
                <div class="large-12 ">
                    <div class="large-4 pull-1 text-center">
                        &copy; Copyright Your Name here.x
                    </div>
                    <div class="large-7 push-2  text-center">
                        <!-- Please Leave this link out of respect for the designer -->
                        
                        	Ce site a été créé avec .com. C'est facile et gratuit. Créez votre site
